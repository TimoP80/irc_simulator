      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={() => {
              // Open the user management import/export modal for channel logs
              const event = new CustomEvent('openChannelLogExport');
              window.dispatchEvent(event);
            }}
            className="bg-green-600 text-white rounded-lg px-4 py-2 text-sm font-semibold hover:bg-green-500 transition-colors flex items-center gap-2"
            title="Export channel chat logs as HTML"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
